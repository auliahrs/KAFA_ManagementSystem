...
@section('content')
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('kafa.updateReportActivity', $activity->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control" id="venue"
                                value="{{ $activity->venue }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="dateStart" class="col-sm-2 col-form-label text-center text-center">Date</label>
                        <div class="col-sm-4">
                            <input type="dateStart" readonly class="form-control" id="dateStart"
                                value="{{ $activity->dateStart }}">
                            <label for="dateEnd" class="col-sm-12 col-form-label text-center text-center">Until</label>
                            <input type="dateEnd" readonly class="form-control" id="dateEnd"
                                value="{{ $activity->dateEnd }}">
                        </div>
                        <label for="timeStart" class="col-sm-2 col-form-label text-center text-center">Time</label>
                        <div class="col-sm-4">
                            <input type="timeStart" readonly class="form-control" id="timeStart"
                                value="{{ $activity->timeStart }}">
                            <label for="timeEnd" class="col-sm-12 col-form-label text-center text-center">Until</label>
                            <input type="timeEnd" readonly class="form-control" id="timeEnd"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10"><input type="text" name="feedback" id="feedback" class="form-control"
                                required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-10 offset-sm-2">
                            ...
                            <a href="{{ route('kafa.listReportActivity') }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </div>
